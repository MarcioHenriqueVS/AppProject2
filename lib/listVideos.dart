  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            TextButton(
              onPressed: () {
                Navigator.push((context),
                    MaterialPageRoute(builder: (context) => EnviarVideo(widget.tema)));
              },
              child: const Text(
                'Adicionar vídeo',
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('Temas dos vídeos').doc(widget.tema).collection('Vídeos').snapshots(),
